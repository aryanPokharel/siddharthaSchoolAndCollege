            ...
            {index == 0 ? (
              ...
              <div className="card" id="mantraCard">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Our institution recognizes and rewards students who achieve
                    distinction in their academic endeavors.
                  </p>
                </div>
              </div>
            ) : index == 2 ? (
              <div className="card" id="mantraCard">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    We foster a culture of scholarship, encouraging students to
                    engage in rigorous study and research.
                  </p>
                </div>
              </div>
            ) : index == 3 ? (
              <div className="card" id="mantraCard">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Our faculty members nurture and celebrate the brilliance of
                    our students, fostering an environment of intellectual
                    curiosity.
                  </p>
                </div>
              </div>
